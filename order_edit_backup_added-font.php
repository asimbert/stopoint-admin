...
function btnpdf1()
{
	...
	window.location = "http://www.stopoint.com/stopointsxgdlj123/order_edit.php?action=edit&id=<?php echo $_GET['id'];?>&p=<?php echo $_GET['p'];?>&key=<?php echo $_GET['key'];?>&res=1";
}
...
<body style="top:-30px;margin-top:-30px;">
	<table style="padding:0px 0;margin-top:-10px;width:100%;">
		<tr>
		<td width="10%" align="left">
				<img src="images/logo.png" style="width:70px;" >
			</td>
			<td width="36%" style="font-size:13px; line-height:1em;">
							<span style="font-size:14px;">STOPOINT INC</span><br/>
				<span style="font-size:13px;">12795 NE 10th Avenue #14</span><br/>
				
				<span style="font-size:13px;">North Miami, FL 33161</span><br/>
				<span style="font-size:13px;">(888) 246-4919</span>
			</td>
			<td width="10%" align="left">
				<img src="images/2.jpg" style="width:70px;" >
			</td>
			<td width="29%" style="font-size:13px; line-height:1em;">
							<span style="font-size:14px;">WELLS FARGO</span> <br/>
						<span style="font-size:13px;">	12700 Biscayne BLVD <br/>
							North Miami, FL 33181<br/>
							(305) 507-0858	</span>
			</td>
			<td width="10%" style="font-size:13px; line-height:1em;">
			<p><br></p>
			<p><br></p>
		<p><br></p>
		
	<p style="font-size:14px;text-align:right;margin-right:5px;margin-top:19px;">Date</p>
						</td>
			
			<td width="14%"  style="text-align:left;">			
			<p style="text-align: right;margin-top:8px;margin-bottom:17px; font-size:17px;">'.$checknumber.'</p> 
			<p><br></p>
			
			<p style="float:left;width:100%; border-bottom:2px solid grey; text-align:center; font-size:15px;margin-top:25px;"> '.date('m/d/Y').' </p>
			</td>
		</tr>
		</table>
		<table style="padding-top:-10px;width:100%;">
		<tr>
			<td style="font-size:12px" width="12%" align="left">
				PAY TO THE<br/>
				ORDER OF
			</td>
			<td width="73%">
				<p style="padding:0 20; border-bottom:2px solid grey; font-size:16px;">
		...
		<tr>
			<td  width="87%" colspan="4" style="border-bottom:2px solid grey; background:url(r.png); background-repeat:repeat-x;">
	...
	<table style="padding:-6px 0%;width:100%;">
		<tr>
			<td width="10%" align="left">
				&nbsp;
			</td>
			<td width="40%" style="font-size:15px; line-height:0.98;">
				'.$weuser['FirstName'].' '.$weuser['LastName'].'<br/>
				'.$address.'<br/>
			...
			<td width="50%">
				...
				<tr>
					<td align="right" style="font-size:12px;margin-top:4px;" width="100%" >
						VOID AFTER 90 DAYS
					</td>
				...
				<tr>
					<td width="100%" style="float:right;" >
						<p style="height:45px;margin-top:-5px;"><img src="images/a.png" width="100" style="margin-bottom:-10px;margin-right:25px;float:right; "></p>
						<p style="width:80%;border-bottom:2px solid grey;margin-left:40%;text-align:right; "></p>
					</td>
				</tr>
				<tr>
					<td width="100%;">
						<p style="margin-left:110; font-size:9px;margin-top:0px;">AUTHORIZED SIGNATURE</p>
					</td>
				</tr>
				</table>
			</td>
	...
	<table style="margin-top:-15;">
		<tr>
			<td style="width:520px;font-size:25px; font-family:'."'MICR E13 B;'".'" align="center" >
				<span style="margin-top:-3px;font-family:'."'MICR E13 B;'".'">C</span>'.$checknumber.'<span style="font-family:'."'MICR E13 B;'".'">C</span>      <span style="font-family:'."'MICR E13 B;'".'">A</span>24617352<span style="font-family:'."'MICR E13 B;'".'">A</span> <span style="font-family:'."'MICR E13 B;'".'">C</span>12308564<span style="font-family:'."'MICR E13 B;'".'">C</span> 
			</td>
